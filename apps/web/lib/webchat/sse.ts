/**
 * Minimal Server-Sent Events parser (WHATWG event-stream format) for a
 * fetch() body — the widget cannot use EventSource because the stream needs an
 * Authorization header. Pure and incremental: feed text chunks as they arrive.
 */
