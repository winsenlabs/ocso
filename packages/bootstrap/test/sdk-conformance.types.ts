...
same<Sdk.ChannelSetupFileType, Channels.ChannelSetupFileType>(true);
same<Sdk.ChannelSetupFileEntry, Channels.ChannelSetupFileEntry>(true);
same<Sdk.ChannelSetupStep, Channels.ChannelSetupStep>(true);
same<Sdk.ChannelTroubleshooting, Channels.ChannelTroubleshooting>(true);
